...
write.table(betweenness, file = "analysis/undirected_betweenness.nt", append = FALSE, quote = FALSE, sep = "\t", row.names = TRUE, col.names = FALSE) #row names to true: takes attribute value (i.e. uri) from vector
